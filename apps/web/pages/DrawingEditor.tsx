          ...
          <Layer>
            ...
            {showGrid && Array.from({ length: 100 }).map((_, i) => (
              <>
                <Line
                  key={`v${i}`}
                  points={[i * GRID_SIZE, 0, i * GRID_SIZE, typeof window !== 'undefined' ? window.innerHeight : 600]}
                  stroke="#e2e8f0"
                  strokeWidth={0.5}
                />
                <Line
                  key={`h${i}`}
                  points={[0, i * GRID_SIZE, typeof window !== 'undefined' ? window.innerWidth : 800, i * GRID_SIZE]}
                  stroke="#e2e8f0"
                  strokeWidth={0.5}
                />
              </>
